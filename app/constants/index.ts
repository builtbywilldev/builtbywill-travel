...
export const user = { name: "Violet" };
export const dashboardStats = {
  totalUsers: 30000,
  usersJoined: { currentMonth: 266, lastMonth: 225 },
  totalTrips: 31023,
  tripsCreated: { currentMonth: 350, lastMonth: 300 },
  userRole: { total: 468, currentMonth: 443, lastMonth: 375 },
};
